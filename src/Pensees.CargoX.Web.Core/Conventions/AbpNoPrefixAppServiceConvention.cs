...
namespace Pensees.CargoX.Conventions
{
    public class AbpNoPrefixAppServiceConvention : IApplicationModelConvention
    {
        private readonly Lazy<AbpAspNetCoreConfiguration> _configuration;

        public AbpNoPrefixAppServiceConvention(IServiceCollection services)
        {
