...
{
    public partial class Shift_To_MySql : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClearTextPassword = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BehaviorDescription = table.Column<string>(maxLength: 256, nullable: true),
                    Appendant = table.Column<string>(maxLength: 128, nullable: true),
                    AppendantDescription = table.Column<string>(maxLength: 256, nullable: true),
